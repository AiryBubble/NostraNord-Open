...
SHORTLINK_DOMAINS = frozenset({
    '0.gp', '0a.sk', '0rz.tw', '1ea.ir',
    '1u.fi', '1un.fr', '1url.cz', '2.gd',
    '2.gp', '2.ly', '2doc.net', '2ly.link',
    '2tu.us', '2u.pw', '2ww.me', '3.ly',
    '301.link', '3c5.com', '3le.ru', '3ly.link',
    '4.gp', '4.ly', '4shorturl.app', '5.gp',
    '5du.pl', '5w.fit', '5z8.info', '6.gp',
    '6.ly', '676.su', '69run.fun', '6g6.eu',
    '7.ly', '707.su', '7oi.de', '8.ly',
    '89q.sk', '92url.com', '985.so', '9k.gg',
    'a0.fr', 'abc.li', 'abelinc.me', 'acortar.link',
    'adf.ly', 'adr3.ir', 'ai6.net', 'alli.pub',
    'alnk.to', 'alturl.com', 'amz.run', 'amzn.id',
    'anon.to', 'appurl.io', 'asin.cc', 'asq.kr',
    'atres.red', 'b.link', 'b2n.ir', 'bc.tc',
    'bc.vc', 'biibly.com', 'bit.do', 'bit.ly',
    'bitly.com', 'bitly.kr', 'bitly.lc', 'bitly.ws',
    'bl.ink', 'blap.net', 'bmai.cc', 'boa.la',
    'bom.so', 'br4.in', 'bre.is', 'brief.ly',
    'bst.bz', 'budurl.com', 'buff.ly', 'bujo.li',
    'c11.kr', 'cal.link', 'cc.cc', 'chatg.pt',
    'chl.li', 'clc.am', 'clc.to', 'cli.re',
    'clicky.me', 'cn.hk.uy', 'cstu.io', 'cut.lu',
    'cut.pe', 'cutt.ly', 'cutt.us', 'cya.nz',
    'd.to', 'd.yzh.li', 'da.gd', 'datayi.cn',
    'dd.ma', 'derpy.me', 'did.li', 'dik.si',
    'dlvr.it', 'dub.link', 'dub.sh', 'dy.si',
    'e.vg', 'ed.gr', 'edu.nl', 'eepurl.com',
    'enshom.link', 'envs.sh', 'evx.ca', 'exe.io',
    'fal.cn', 'fig.page', 'firsturl.de', 'firsturl.net',
    'flii.by', 'flip.it', 'forms.gle', 'fr.rog.gg',
    'fumacrom.com', 'fupi.co.tz', 'g.asia', 'gclnk.com',
    'gdurl.com', 'geni.us', 'gestyy.com', 'gg.gg',
    'ggl.link', 'git.new', 'go.ly', 'go.shr.lc',
    'goo.by', 'goo.gl', 'goo.su', 'goolink.cc',
    'goolnk.com', 'gr.pn', 'grnh.se', 'gtly.to',
    'haa.su', 'han.gl', 'heylink.me', 'hi.switchy.io',
    'hit.kg', 'hm.ru', 'hoy.kr', 'href.li',
    'htl.li', 'htn.to', 'hubs.la', 'hubs.li',
    'i.mtr.cool', 'iatp.by', 'ibit.ly', 'icit.fr',
    'icks.ro', 'idm.in', 'ift.tt', 'ii1.su',
    'iii.im', 'iiil.io', 'ilang.in', 'ilnk.io',
    'inlnk.ru', 'inx.lv', 'iplog.link', 'is.gd',
    'itsssl.com', 'ity.im', 'ix.sk', 'ja.cat',
    'jd.cn.hn', 'jdem.cz', 'jio.sh', 'jkf.lv',
    'jo.my', 'joo.gl', 'jpeg.ly', 'kbit.co',
    'klck.me', 'knw.one', 'ko.gl', 'kortlink.dk',
    'kr.pe', 'kutt.it', 'l-i-nk.me', 'l-ink.me',
    'l.linklyhq.com', 'l2o.ir', 'lc.cx', 'lihi.cc',
    'lihi.one', 'lihi.tv', 'lihi.vip', 'lihi1.cc',
    'lihi1.com', 'lihi1.me', 'lihi2.cc', 'lihi2.com',
    'lihi3.cc', 'lihi3.com', 'link.ac', 'link.gy',
    'link.infini.fr', 'linkclickcounter.com', 'linkfly.to', 'linkjust.com',
    'linklyhq.com', 'links2.me', 'linkye.net', 'llk.dk',
    'lmg.gg', 'lmy.de', 'ln.run', 'lnk.bz',
    'lnk.direct', 'lnk.do', 'lnk.sk', 'lnk.to',
    'lnkiy.in', 'lnky.jp', 'lnkz.at', 'lnnk.in',
    'loom.ly', 'lru.jp', 'lstu.fr', 'lttr.ai',
    'many.at', 'me.sv', 'me2.kr', 'merky.de',
    'mex.su', 'mitsha.re', 'mng.bz', 'mork.ro',
    'mrx.cl', 'msi.gm', 'mub.me', 'my.mtr.cool',
    'mylinkinb.io', 'myurls.ca', 'n9.cl', 'name.ly',
    'nav.cx', 'neti.cc', 'nfw.cz', 'nnna.ru',
    'notlong.com', 'oal.lu', 'oe.cd', 'ofcour.se',
    'offf.to', 'okt.to', 'onx.la', 'orlo.uk',
    'osdb.link', 'ouo.io', 'ouo.press', 'ourl.in',
    'ourl.tw', 'ovh.to', 'ow.ly', 'owl.li',
    'p.asia', 'packt.link', 'peek.link', 'pesc.pw',
    'piee.pw', 'pixly.me', 'plu.sh', 'ppt.cc',
    'pros.is', 'psce.pw', 'pse.is', 'psee.io',
    'qoo.by', 'qptr.ru', 'qq.cn.hn', 'qr.ae',
    'qrco.de', 'qrs.ly', 'queer.li', 'rb.gy',
    'rdcu.be', 'readhacker.news', 'rebrand.ly', 'redd.it',
    'redir.ec', 'relink.asia', 'replug.link', 'reurl.cc',
    'risu.io', 'rizy.ir', 'rlu.ru', 'rotf.lol',
    's.coop', 's.ee', 's.id', 's.mj.run',
    's.wikicharlie.cl', 'sdu.sk', 'seagate.media', 'sendgrid.net',
    'sgq.io', 'sh.st', 'shiny.link', 'shorl.com',
    'short.gy', 'shorte.st', 'shorten.asia', 'shorten.is',
    'shorturl.ae', 'shorturl.asia', 'shorturl.at', 'shorturl.com',
    'shorturl.gg', 'shrtco.de', 'shrtm.nu', 'shrunken.com',
    'sht.moe', 'sie.ag', 'simp.ly', 'skr.sk',
    'skrat.it', 'skyurl.cc', 'smart.link', 'smarturl.it',
    'smlk.es', 'smsb.co', 'smu.gs', 'snip.link',
    'snip.ly', 'snyk.co', 'social.ora.cl', 'socx.in',
    'sourl.cn', 'sovrn.co', 'split.to', 'spr.ly',
    'sptfy.com', 'spti.fi', 'sqzr.cz', 'ssur.cc',
    'stspg.io', 'stuf.in', 'suo.im', 'supr.link',
    'sur.ly', 'surl.li', 'swag.run', 'switchy.io',
    'swiy.co', 'swll.to', 'sy.to', 't.cn',
    't.co', 't.hk.uy', 't.ly', 't.tl',
    't1p.de', 't2m.io', 't2mio.com', 'taiwangov.com',
    'tb.cn.hn', 'tg.pe', 'tgam.ca', 'thatis.me',
    'thefp.pub', 'thinfi.com', 'thrill.to', 'tinu.be',
    'tiny.cc', 'tiny.ee', 'tiny.one', 'tiny.pl',
    'tiny.sg', 'tinylink.net', 'tinyurl.com', 'tinyurl.hu',
    'tinyurl.mobi', 'tl.gd', 'tmblr.co', 'tnw.to',
    'tny.cz', 'tny.so', 'to.ly', 'to.pbs.org',
    'toi.in', 'tokopedia.link', 'topt.al', 'tpmr.com',
    'trib.al', 'trimmer.to', 'tsbk.tw', 'tt.vg',
    'twb.nz', 'twtr.to', 'u.nu', 'u.shxj.pw',
    'u.to', 'u6v.cn', 'ukoeln.de', 'ul.to',
    'ul3.ir', 'ulvis.net', 'ume.la', 'uoft.me',
    'up.to', 'ur3.us', 'url.cn', 'url.cy',
    'url.ie', 'url.vet', 'url2.fr', 'urla.ru',
    'urlday.cc', 'urlgeni.us', 'urli.ai', 'urlify.cn',
    'urlis.net', 'urlme.cc', 'urlo.in', 'urlr.me',
    'urls.by', 'urls.fr', 'urls.kr', 'urly.fi',
    'urlz.com', 'urlz.fr', 'urlzs.com', 'utm.to',
    'utn.pl', 'utraker.com', 'v.gd', 'v.ht',
    'v.redd.it', 'vai.la', 'vbly.us', 'vd55.com',
    'vk.cc', 'vk.sv', 'vo.la', 'vur.me',
    'vurl.com', 'w.idg.de', 'w.wiki', 'wa.gl',
    'wa.link', 'wa.me', 'waa.ai', 'wbze.de',
    'wee.so', 'wenk.io', 'wf0.xin', 'whatel.se',
    'whereel.se', 'whoel.se', 'wi.se', 'wl.co',
    'wn.nr', 'wp.me', 'ww7.fr', 'www.shrunken.com',
    'x.gd', 'xfru.it', 'xn--57h.ws', 'xn--a-4ka.eu',
    'xn--k28h.tk', 'xn--ms8h.st', 'xor.tw', 'xrl.us',
    'xurl.es', 'xy2.eu', 'y.ahoo.it', 'y2u.be',
    'yadi.sk', 'yal.su', 'yip.su', 'your.ls',
    'zaya.io', 'zc.vg', 'zcu.io', 'zeep.ly',
    'zipurl.link', 'zoho.to', 'zopen.to', 'zpr.io',
    'zurl.co', 'zurl.ir', 'zws.im', 'zzb.bz',
})
